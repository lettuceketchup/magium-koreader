// Auto-converted from ch1.magium by magium_to_ink.js (spike 05).
// Fidelity gaps are marked inline with '# SPECIAL:' / '# ACHIEVEMENT:' tags and in FINDING.md.

VAR v_ac_ch1_coward = 0
VAR v_ac_ch1_die = 0
VAR v_ac_ch1_honesty = 0
VAR v_ch1_intro_feeling = 0
VAR v_ch1_show_yourself = 0
VAR v_ch1_stillwater = 0
VAR v_ch2_human_reason = 0
VAR v_chapter_save_counter = 0
VAR v_checkpoint_rich = 0
...
{v_ch1_show_yourself == 1:
    ...
    "You're not going to get that knife out so easily. My knives have a life of their own, and they only listen to me. Now that I know where you are, I'm going to..."
    
    He pauses.
    
    "So you're a stillwater, eh? Trying to get me to lower my guard by acting like an idiot? Trying to lull me into a false sense of security? Is that your plan? Well it ain't gonna work on me. Cause I'm too smart for that, you hear me?!"
    
}
{v_ch1_show_yourself == 2:
    I breathe in deeply and try to appear as calm as possible. I step out of the forest and into the clearing, facing the mage with the knives directly.
    
    "Who are you calling a coward?" I ask him.
    
    The mage pauses for a bit as he measures me up and down.
    
    "A stillwater, eh?" he says, finally. He tried hard to keep his composure when asking his question, but the tremor in his voice betrayed him. He is afraid.
    
}
{v_ch1_show_yourself == 3:
    "I see no reason to show myself to you," I tell him.
    
    As he pinpoints my location from the sound of my voice, the mage makes a rather long pause before speaking again.
    
    "A stillwater, eh?" he says, finally. He tried hard to keep his composure when asking his question, but the tremor in his voice betrayed him. He is afraid.
    
}
His sudden change of attitude towards me is not completely unexpected. The existence of stillwaters is one of the main reasons I've dared to dream that I might have a chance to win this tournament.
...
# ACHIEVEMENT: "Who are you calling a coward?" (v_ac_ch1_coward) — Ink has no built-in achievement UI; a host script reading this tag would still need to implement display + persistence itself, same as any other target.
* [Give him until the count of ten to retreat]
    ~ v_ac_ch1_die = 1
    -> K_Ch1_Retreat
...
"I'm going to give you until the count of ten to get out of my sight," I tell him.

"Hah! Empty words. That's all you've got. Arm yourself, fool! Today, I become a legend!"


{v_ch1_show_yourself == 1:
    Once he's done talking, I hear the mage throw several knives towards the forest. I desperately try to pull the knife out of my shoulder, but it's no use. Five of the mage's knives race past me, and turn in midair just like the last one did. I try to somehow get out of their way, but the knife in my shoulder is still keeping me pinned against the tree.
    
    The last thing I feel is the sharp pain of all those knives impaling me, as my consciousness slowly starts fading away.
    
}
{v_ch1_show_yourself == 2:
    Once he's done talking, the mage throws five daggers simultaneously towards me. I try to dodge them but they're so fast I barely even get the time to blink. It was all over in an instant. As I feel the pain from the daggers, my consciousness slowly starts fading away.
    
}
{v_ch1_show_yourself == 3:
    Once he's done talking, I hear the mage throw several knives towards the forest. They all race past me, but before I get the chance to even think what to do next, the knives suddenly turn in midair and fly towards me, impaling me where I stand. It all ended so fast I barely even had the time to realize I was dead.
    
}


# ACHIEVEMENT: "Off to a good start" (v_ac_ch1_die) — Ink has no built-in achievement UI; a host script reading this tag would still need to implement display + persistence itself, same as any other target.
* [Restart game]
    # SPECIAL:restart — a host-level action (save/restart/stats), not story content; Ink has no equivalent primitive, same gap a native engine would still have to bridge with a custom function binding.
    -> K_Ch1_Intro1
* [Load game]
    # SPECIAL:saves — a host-level action (save/restart/stats), not story content; Ink has no equivalent primitive, same gap a native engine would still have to bridge with a custom function binding.
    -> Unsupported_no_target
...
{v_ch1_show_yourself == 2:
    The mage was about to go for his knives, but now he stopped. He is looking at me quite intently, without averting his eyes for even a second.
    
}
{v_ch1_show_yourself != 2:
    After I say that, there's a long pause in which none of us says anything.
...
{v_ch1_show_yourself == 1:
    ...
    "I'll remember this, stillwater. Don't think I won't. You'll rue the day you messed with Cutthroat Dave. And the same goes for you, healer in armor.  I'll be seeing the both of you again soon."
    
    After he finishes his speech, he turns away in disgust as he heads into the woods on the opposite side of the clearing. The dagger from my shoulder pulls itself out on its own and hurries to catch up with its master.
    
}
{v_ch1_show_yourself == 2:
    The mage's face contorts into a scowl, but he says nothing. He doesn't seem to want to push his luck any further. He reluctantly puts his daggers back into his belt and then he spits on the ground next to Daren.
    ...
    After he finishes his speech, he turns away in disgust as he heads into the woods on the opposite side of the clearing.
...
* [Tell him I'm actually an ordinary human]
    ~ v_ch1_stillwater = 2
    -> K_Ch1_Ordinary
...
"Yes. My parents had a really weird sense of humor. Speaking of names, aren't you supposed to be a hero of legend? How exactly does one as strong as you get bested so easily by someone named Cutthroat Dave?"
...
{v_ch1_show_yourself != 1:
    He demonstrates it by raising his hands in the air and making a white light appear all around him. As the light shines, his wounds start closing, and the blood fades away.
...
* [Next chapter]
    ...
    ~ v_checkpoint_rich = 1
    # SPECIAL:checkpoint_save — a host-level action (save/restart/stats), not story content; Ink has no equivalent primitive, same gap a native engine would still have to bridge with a custom function binding.
    -> K_Ch2_Intro
...
* [Tell him the truth]
    ~ v_ac_ch1_honesty = 1
    ~ v_ch2_human_reason = 1
    -> K_Ch1_Truth
* [Tell him I was forced into it]
    ~ v_ch2_human_reason = 2
    -> K_Ch1_Forced
* [Tell him I'm looking for a cure for my sick sister]
    ~ v_ch2_human_reason = 3
    -> K_Ch1_Sister

=== K_Ch1_Truth ===


"I'm after the same thing as you, Daren," I tell him. "I'm after the Magium.  It's been my dream ever since I was little to become a mage, and the Magium can grant me that wish."
...
# ACHIEVEMENT: "Honesty is the best policy." (v_ac_ch1_honesty) — Ink has no built-in achievement UI; a host script reading this tag would still need to implement display + persistence itself, same as any other target.
* [Continue]
    -> K_Ch1_Weakness
...
"I didn't come here by choice," I tell him. "Believe me, I would love nothing more than to leave this place and never look back. But that's not really an option for me at this point. All I can do now is try to survive until the end of the tournament."
...
"Not to sound ungrateful but... I'm not finding this very reassuring. I mean, I did just witness you get completely wrecked by that knife throwing guy. How does one as strong as you get bested so easily by someone named Cutthroat Dave, anyway?"
...
=== Unsupported_no_target ===
This choice has no target scene in the original data (a host-level action like "load game" — see the SPECIAL tag above it).
-> END

=== K_Ch2_Intro ===
(stub: "Ch2-Intro" is outside this one-chapter conversion)
-> END
