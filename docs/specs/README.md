...
| [2026-09-07-phase-vi-settings.md](2026-09-07-phase-vi-settings.md) | draft — implementing | **Phase VI**: scoping pass (theme/language not ported); cheat mode + reader text-size presets (`magium_prose_size`); custom-reader viewport robustness — choices scroll on overflow, `prose_height` floor, `test-ui-matrix` across 4 device profiles. |
