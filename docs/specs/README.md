...
| [2026-09-08-phase-viii-polish.md](2026-09-08-phase-viii-polish.md) | draft — awaiting owner review | **Phase VIII** (final): measurement-driven polish — one instrumented device pass, then e-ink tuning (`ui/refresh.lua`, OQ-007) + conditional OQ-011 / GC mitigations only if measured needed; OQ-011 dev bench (`condition_perf_spec.lua`); full-corpus QA; `INSTALL.md` + `v1.0` tag; project declared feature-complete. |
